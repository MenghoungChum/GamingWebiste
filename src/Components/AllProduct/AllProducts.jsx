...
const AllProducts = () => {
  ...
  return (
    <section>
        ...
        <div className='max-w-[1440px] mx-auto px-10 py-20 flex flex-wrap gap-3 md:gap-5 lg:gap-7'>
            {
                AllProductsList.map(item=>(
            <div data-aos='zoom-in' key={item.id} className={`lg:w-[23%] w-full md:w-[31%] md:h-[460px] bg-zinc-800 rounded-2xl cursor-pointer group border overflow-hidden transition-all duration-300 ease-in-out dark:bg-transparent ${item.shadow} ${item.borderColor}`}>
