...
import { keyboardGaming } from '../ProductList/ProductList'
import { FaHeart, FaRegHeart } from 'react-icons/fa'
import { LuShoppingCart } from 'react-icons/lu'
import { IoStar } from 'react-icons/io5'
import keyboardBanner from '../../assets/KeyboardBanner.jpg'
                ...
                <div className='p-4'>
                    ...
                    <div className='flex items-center justify-between'>
                        ...
                        <Link 
                            ...
                            className={`text-white px-3 py-1 rounded-lg bottom-4  flex items-center cursor-pointer gap-2 transition-all duration-300 ease-in-out ${item.bgBtn} ${item.btnShadow}`}><span><BiSolidCommentDetail /></span><span>See detail</span>
                        </Link>
                    </div>
                </div>
            </div>
