  ...
  return (
    <section>
        <div className='max-w-[1440px] mx-auto lg:px-10 px-4 py-10 flex flex-wrap gap-3 md:gap-5 lg:gap-7'>
            ...
            <div data-aos='zoom-in' key={item.id} className={`lg:w-[23%] w-full md:w-[31%] md:h-[460px] bg-zinc-800 dark:bg-transparent rounded-2xl cursor-pointer group border overflow-hidden transition-all duration-400 ease-in-out ${item.shadow} ${item.borderColor}`}>
